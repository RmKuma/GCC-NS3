...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-std=c++11', '-Wall', '-Wno-deprecated-declarations', '-Wno-unused-local-typedefs', '-Wno-narrowing', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-std=c++11', '-Wall', '-Wno-deprecated-declarations', '-Wno-unused-local-typedefs', '-Wno-narrowing', '-std=c++11']
...
EXAMPLE_DIRECTORIES = ['tcp', 'udp', 'realtime', 'naming', 'tutorial', 'stats', 'traffic-control', 'socket', 'wireless', 'udp-client-server', 'ipv6', 'routing', 'matrix-topology', 'energy', 'error-model']
...
NS3_EXECUTABLE_PATH = ['/home/shjeong/workspace/ns-allinone-3.28/ns-3.28/build/src/fd-net-device', '/home/shjeong/workspace/ns-allinone-3.28/ns-3.28/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/shjeong/workspace/ns-allinone-3.28/ns-3.28/build']
...
VALGRIND_FOUND = True
VERSION = '3.28'
WITH_PYBINDGEN = '/home/shjeong/workspace/ns-allinone-3.28/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/shjeong/workspace/ns-allinone-3.28/ns-3.28/build/ns3/config-store-config.h', '/home/shjeong/workspace/ns-allinone-3.28/ns-3.28/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
